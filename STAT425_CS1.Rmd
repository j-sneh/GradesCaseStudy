...
```
Looking at the figures above, we used a histogram to plot the residuals between our full model and our reduced model. Our reduced model’s plot is more symmetric than our full model, suggesting our reduced model may fit the data better than our full model. Figure 11 shows the outliers for the full model and figure 12 shows the outliers for the reduced model. As expected, our reduced model has significantly fewer outliers than our full model.
